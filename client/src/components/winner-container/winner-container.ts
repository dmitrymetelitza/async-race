...
import { ICar, IWinner, IWinnerCar } from '../../inteface/insdex';
import { WinnersItem } from './winner-item';
import { getCar } from '../../api/api';
import { Pagination } from '../shared/pagination/pagination';

import './winner-container-style.scss';
...
export class WinnersContainer extends Component {
  ...
  constructor(parentNode: HTMLElement) {
    ...
    winnerTime?.addEventListener('click', () => this.handleSortWinners(winnerTime, 'time'));
  ...
  addWinners(winners: { result: Array<IWinner>; totalCount: string | null }): void {
