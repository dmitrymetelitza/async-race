...
export class OptionsButtons extends Component {
  ...
  constructor(parentNode: HTMLElement) {
    ...
    this.buttonRace = new UIButton(this.element, ['garage-race-button'], 'race');
    this.buttonRace.onClickButton = () => this.startRaceAllCars();

    this.buttonReset = new UIButton(this.element, ['garage-reset-button'], 'reset', true);
    this.buttonReset.onClickButton = () => this.resetAllCars();

    this.buttonGenerateCars = new UIButton(this.element, ['garage-generate-button'], 'generate cars');
