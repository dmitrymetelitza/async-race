...
import { UIInput } from '../createCar/input/input';
import { ICreateCar } from '../../inteface/insdex';
...
export class OptionsInputs extends Component {
  ...
  constructor(parentNode: HTMLElement, buttonText: string, styles: string[] = []) {
    ...
    this.inputColor = new UIInput(this.element, 'color', ['garage-color-input'], '#000000');
